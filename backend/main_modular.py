...
async def ml_training_task_10_models():
    ...
    while True:
        try:
            # Import training state from routes
            from .routes.training import training_paused, current_training_coin, current_training_model, training_progress
            ...
            for model_type in model_types:
                ...
                try:
                    ...
                    # Update global state
                    training.current_training_coin = current_coin.symbol
                    training.current_training_model = model_type
                    training.training_progress = 0
                    ...
                    for step in range(10):
                        if training_paused:
                            break
                        training.training_progress = int((step + 1) / 10 * 100)
                        await asyncio.sleep(training_time / 10)
                    
                    # Simple prediction logic (placeholder for real ML)
